        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=61576843890719" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brandguardian-600">
              ...
              <a href="https://www.linkedin.com/company/bndbox" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brandguardian-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/admin/login" className="text-gray-600 hover:text-brandguardian-600">Admin Login</a></li>
            </ul>
          </div>
