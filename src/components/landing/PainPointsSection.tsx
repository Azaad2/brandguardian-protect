      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {painPoints.map((point, index) => (
            <Card key={index} className="transition-all duration-300 feature-card border-gray-200 hover:border-bndbox-300">
              <CardContent className="p-8">
                <div className="h-12 w-12 rounded-lg bg-bndbox-50 flex items-center justify-center mb-6">
                  {point.icon}
                </div>
