-- Phase 1: Fix Database Schema & Add Document Verification
...
ALTER TABLE public.reseller_applications 
ADD COLUMN IF NOT EXISTS application_status text DEFAULT 'submitted' CHECK (application_status IN ('submitted', 'document_pending', 'document_review', 'pending', 'approved', 'rejected'));
...
GRANT EXECUTE ON FUNCTION public.admin_get_reseller_applications() TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.admin_verify_document(uuid, boolean, text) TO authenticated;